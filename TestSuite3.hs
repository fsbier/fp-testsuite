...
spec =
  testGroup
    ...
    [
      ...
      testCase "Num ungueltig" $ assertError "Vergleich nicht moeglich" (compare Ungueltig Leer),
      testCase "Num ungueltig" $ assertError "Vergleich nicht moeglich" (compare Leer Ungueltig),
